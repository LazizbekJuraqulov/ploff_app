...
class PlacemarkMapObjectPage extends StatelessWidget {
  const PlacemarkMapObjectPage() : super();
                ...
                children: <Widget>[
                  ...
                  ElevatedButton(
                      onPressed: () async {
                        setState(() {
                          mapObjects
                              .removeWhere((el) => el.mapId == mapObjectId);
                        });
                      },
                      child: Text('Remove')),
                ],
                      ...
                      onPressed: () async {
                        ...
                        setState(() {
                          mapObjects[mapObjects
                                  .indexOf(mapObjectWithDynamicIcon)] =
                  ...
                  ElevatedButton(
                      onPressed: () async {
                        ...
                        final mapObjectWithCompositeIcon = PlacemarkMapObject(
                          ...
                          point:
                              Point(latitude: 34.820045, longitude: 45.945933),
                          onTap: (PlacemarkMapObject self, Point point) =>
                              print('Tapped me at $point'),
                          isDraggable: true,
                          onDragStart: (_) => print('Drag start'),
