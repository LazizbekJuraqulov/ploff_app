...
//
//     final hiveProductModel = hiveProductModelFromJson(jsonString);
...
HiveProductModel hiveProductModelFromJson(String str) =>
    HiveProductModel.fromJson(json.decode(str));

String hiveProductModelToJson(HiveProductModel data) => json.encode(data.toJson());
...
class HiveProductModel {
  ...
  factory HiveProductModel.fromJson(Map<String, dynamic> json) => HiveProductModel(
        id: json["id"],
        slug: json["slug"],
        title: (json["title"]),
        code: json["code"],
