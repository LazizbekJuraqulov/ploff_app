...
//
//     final disegnModel = disegnModelFromJson(jsonString);

import 'dart:convert';

DisegnModel disegnModelFromJson(String str) => DisegnModel.fromJson(json.decode(str));

String disegnModelToJson(DisegnModel data) => json.encode(data.toJson());
...
class DisegnModel {
    ...
    factory DisegnModel.fromJson(Map<String, dynamic> json) => DisegnModel(
